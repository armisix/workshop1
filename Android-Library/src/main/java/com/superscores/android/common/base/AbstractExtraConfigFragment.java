...
/**
 * Base Fragment that implements extended lifecycle and extra configuration. <p/> Created by Pongpat
 * on 2/11/15.
 */
public abstract class AbstractExtraConfigFragment extends Fragment {
