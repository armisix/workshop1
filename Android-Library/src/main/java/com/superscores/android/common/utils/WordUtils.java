 ...
 * for a <code>null</code> input. Each method documents its behaviour in more detail.
 * </p>
 * 
 * @since 2.0
 * @version $Id$
...
public class WordUtils {
    ...
    /**
     * <p>
     * <code>WordUtils</code> instances should NOT be constructed in standard programming. Instead,
     * the class should be used as <code>WordUtils.wrap("foo bar", 20);</code>.
     * </p>
     * 
     * <p>
