...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float CENTER_RADIUS = 16.0f;
    ...
    private static final float ARROW_OFFSET_ANGLE = 8;
    ...
    private void updateRingParams() {
        final DisplayMetrics metrics = mResources.getDisplayMetrics();
        final float screenDensity = metrics.density;
        final int defaultDiameter = (int) (CIRCLE_DIAMETER * screenDensity);
        updateRingParams(new Rect(0, 0, defaultDiameter, defaultDiameter));
    }

    private void updateRingParams(Rect bounds) {
        if (mCurrentBounds == null || !mCurrentBounds.equals(bounds)) {
            ...
            int newDiameter = newWidth > newHeight ? newHeight : newWidth;
            float multiplyRatio = newDiameter / (float) defaultDiameter;
            Math.pow(multiplyRatio, 1.2);

            double progressCircleWidth = CIRCLE_DIAMETER * multiplyRatio;
            double progressCircleHeight = CIRCLE_DIAMETER * multiplyRatio;
            double centerRadius = CENTER_RADIUS * multiplyRatio;
            double strokeWidth = STROKE_WIDTH * multiplyRatio;

            float arrowWidth = ARROW_WIDTH * multiplyRatio;
            float arrowHeight = ARROW_HEIGHT * multiplyRatio;

            setSizeParameters(progressCircleWidth, progressCircleHeight, centerRadius, strokeWidth,
    ...
    private static class Ring {
        ...
        /**
         * @param index
         *            Index into the color array of the color to display in the progress spinner.
         */
